...
PLUGIN_NAME="figma-codegen"
PLUGIN_DIR="$(cd "$(dirname "$0")/.." && pwd)"
REPO_ROOT="$(cd "$PLUGIN_DIR/../.." && pwd)"
DIST_DIR="$REPO_ROOT/dist/$PLUGIN_NAME"

echo "=== figma-codegen 构建流程 ==="
...
# Skills(含 LICENSE / agents / assets)
...
EXPECTED_FILES=(
  ...
  "skills/figma-codegen/LICENSE.txt"
  "skills/figma-codegen/agents/claude.yaml"
  "skills/figma-codegen/assets/figma-small.svg"
  "skills/figma-codegen/assets/figma.png"
  "skills/figma-codegen/assets/icon.svg"
  "CLAUDE.md"
)
