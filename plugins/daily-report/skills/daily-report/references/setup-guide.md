...
- [前置条件](#前置条件)
- [一、lark-cli 安装与配置（必需）](#一lark-cli-安装与配置必需)
  - [1.1 安装 CLI 本体](#11-安装-cli-本体)
  - [1.2 安装 Skill（接入 AI Agent 必需）](#12-安装-skill接入-ai-agent-必需)
  - [1.3 初始化飞书应用凭据](#13-初始化飞书应用凭据)
  - [1.4 授权飞书权限 (scope)](#14-授权飞书权限-scope)
  - [1.5 验证](#15-验证)
- [二、飞书权限说明](#二飞书权限说明)
- [三、内控日报 API 配置](#三内控日报-api-配置)
  - [3.1 提供账号信息](#31-提供账号信息)
  - [3.2 自动登录](#32-自动登录)
  - [3.3 补充配置](#33-补充配置)
  - [3.4 安全说明](#34-安全说明)
- [四、Token 自动刷新](#四token-自动刷新)
...
> **提示**: 以上信息仅首次填写，安全保存在本地配置文件中，后续运行自动读取，无需再次输入。
