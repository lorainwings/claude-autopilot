...
echo "--- 40. Phase 4 change_coverage validation (_post_task_validator.py) ---"
...
exit_code=0
output=$(run_validator '{"tool_name":"Task","cwd":"'"$REPO_ROOT"'","tool_input":{"prompt":"<!-- autopilot-phase:4 -->\nPhase 4"},"tool_response":"Result: {\"status\":\"ok\",\"summary\":\"Tests created\",\"artifacts\":[\"tests/test_foo.py\"],\"test_counts\":{\"unit\":8,\"api\":5,\"e2e\":3,\"ui\":2},\"sad_path_counts\":{\"unit\":2,\"api\":1,\"e2e\":1,\"ui\":1},\"dry_run_results\":{\"unit\":0,\"api\":0,\"e2e\":0,\"ui\":0},\"test_pyramid\":{\"total\":18,\"unit_pct\":44,\"integration_pct\":28,\"e2e_pct\":28},\"change_coverage\":{\"change_points\":[\"POST /api/foo\",\"FooService.bar\",\"ChatPanel.vue\"],\"tested_points\":[\"POST /api/foo\"],\"coverage_pct\":33,\"untested_points\":[\"FooService.bar\",\"ChatPanel.vue\"]}}"}') || exit_code=$?
...
exit_code=0
output=$(run_validator '{"tool_name":"Task","cwd":"'"$REPO_ROOT"'","tool_input":{"prompt":"<!-- autopilot-phase:4 -->\nPhase 4"},"tool_response":"Result: {\"status\":\"ok\",\"summary\":\"Tests created\",\"artifacts\":[\"tests/test_foo.py\"],\"test_counts\":{\"unit\":8,\"api\":5,\"e2e\":3,\"ui\":2},\"sad_path_counts\":{\"unit\":2,\"api\":1,\"e2e\":1,\"ui\":1},\"dry_run_results\":{\"unit\":0,\"api\":0,\"e2e\":0,\"ui\":0},\"test_pyramid\":{\"total\":18,\"unit_pct\":44,\"integration_pct\":28,\"e2e_pct\":28}}"}') || exit_code=$?
...
exit_code=0
output=$(run_validator '{"tool_name":"Task","cwd":"'"$REPO_ROOT"'","tool_input":{"prompt":"<!-- autopilot-phase:4 -->\nPhase 4"},"tool_response":"Result: {\"status\":\"ok\",\"summary\":\"Tests\",\"artifacts\":[\"t.py\"],\"test_counts\":{\"unit\":10,\"api\":5,\"e2e\":3,\"ui\":2},\"sad_path_counts\":{\"unit\":2,\"api\":1,\"e2e\":1,\"ui\":1},\"dry_run_results\":{\"unit\":0,\"api\":0,\"e2e\":0,\"ui\":0},\"test_pyramid\":{\"total\":20,\"unit_pct\":50,\"integration_pct\":25,\"e2e_pct\":25},\"change_coverage\":{}}"}') || exit_code=$?
