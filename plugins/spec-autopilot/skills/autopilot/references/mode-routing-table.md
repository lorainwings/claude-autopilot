...
- [1. 模式 → 阶段序列映射](#1-模式--阶段序列映射)
- [2. 模式解析优先级](#2-模式解析优先级)
- [3. Phase 5 任务来源（模式感知）](#3-phase-5-任务来源模式感知)
- [4. Phase 5 路径选择（优先级链）](#4-phase-5-路径选择优先级链)
- [5. Phase 4 与 TDD 的关系（决策矩阵）](#5-phase-4-与-tdd-的关系决策矩阵)
- [6. 门禁跳过矩阵（模式感知）](#6-门禁跳过矩阵模式感知)
- [7. Phase 6 三路并行](#7-phase-6-三路并行)
