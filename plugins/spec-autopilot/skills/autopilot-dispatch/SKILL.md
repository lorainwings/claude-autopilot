...
**执行前读取**: `../autopilot/references/parallel-dispatch.md`（通用协议）+ 当前 Phase 对应的并行配置：Phase 1/4/5/6 分别见 `../autopilot/references/parallel-phase1.md`、`../autopilot/references/parallel-phase4.md`、`../autopilot/references/parallel-phase5.md`、`../autopilot/references/parallel-phase6.md`
