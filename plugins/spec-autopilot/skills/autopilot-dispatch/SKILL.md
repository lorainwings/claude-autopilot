...
本 Skill 依赖 `runtime/scripts/_common.sh` 提供的以下共享函数，**不重复实现**配置/锁文件解析：
...
### 优先级 2.5: Project Rules Auto-Scan
...
**执行前读取**: autopilot skill 的 `parallel-dispatch.md` 章节（通用协议）+ 当前 Phase 对应的并行配置：Phase 1/4/5/6 分别见 autopilot skill 的 `parallel-phase1.md`、`parallel-phase4.md`、`parallel-phase5.md`、`parallel-phase6.md` 章节
