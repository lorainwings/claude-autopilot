...
**执行前读取**: `autopilot/references/parallel-dispatch.md`（完整的 Phase 1/4/5/6 并行 Task prompt 模板）

概要：当阶段支持并行执行时，dispatch 按 `references/parallel-dispatch.md` 构造并行 Task prompt。
