...
> This index covers all documentation for spec-autopilot v5.4, organized by category. Includes Event Bus, GUI V2 Dashboard, parallel dispatch, requirements routing, and more.
