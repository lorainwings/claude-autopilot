...
Launch the GUI dashboard: `bun run plugins/spec-autopilot/scripts/autopilot-server.ts`, then open `http://localhost:9527`. All phase progress, gate decisions, and task progress are pushed to the browser in real-time.
