...
路由分类定义于 `skills/autopilot/references/phase1-requirements.md` Step 1.1.6，采用**确定性关键词匹配**（非 AI 判断）。
...
定义于 `skills/autopilot/references/phase1-supplementary.md`:
...
定义于 `skills/autopilot/references/phase1-requirements.md` Step 1.6:
