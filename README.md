...
| [slim-task](plugins/slim-task/README.md) | 0.4.0 | Structured 7-phase task execution SOP with multi-language & worktree support — session init, requirements clarification, impact scoping, DAG-based parallel dispatch, blind-audit quality review |
