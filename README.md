...
| [parallel-harness](plugins/parallel-harness/) | 1.0.4 | Parallel AI engineering control-plane — task-graph scheduling, 9-gate system, RBAC governance, cost-aware model routing |
