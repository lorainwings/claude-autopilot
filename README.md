...
|--------|---------|-------------|
| [spec-autopilot](plugins/spec-autopilot/) | 5.3.1 | Spec-driven autopilot orchestration for delivery pipelines — 8-phase workflow with 3-layer gate system and crash recovery |
| [parallel-harness](plugins/parallel-harness/) | 1.3.0 | Parallel AI engineering control-plane — task-graph scheduling, 9-gate system, RBAC governance, cost-aware model routing |
| [daily-report](plugins/daily-report/README.md) | 1.2.7 | Auto-generate and submit daily work reports from git commits and Lark chat history |
