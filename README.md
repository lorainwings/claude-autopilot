...
|--------|---------|-------------|
| [spec-autopilot](plugins/spec-autopilot/) | 5.5.2 | Spec-driven autopilot orchestration for delivery pipelines — 8-phase workflow with 3-layer gate system and crash recovery |
