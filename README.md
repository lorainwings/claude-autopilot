...
|--------|---------|-------------|
| [spec-autopilot](plugins/spec-autopilot/) | 5.15.3 | Spec-driven autopilot orchestration for delivery pipelines — 8-phase workflow with 3-layer gate system and crash recovery |
...
| [slim-task](plugins/slim-task/README.md) | 0.8.0 | Structured 7-phase task execution SOP with multi-language & worktree support — session init, requirements clarification, impact scoping, DAG-based parallel dispatch, blind-audit quality review |
